...
declare const ToastComponent: ({ title, date }: ToastComponentProps) => JSX.Element;
...
export { Avatar, AvatarProps, Box, BoxProps, Button, ButtonProps, Checkbox, CheckboxProps, Heading, HeadingProps, MultiStep, MultiStepProps, Text, TextArea, TextAreaProps, TextInput, TextInputProps, TextProps, ToastComponent, config, createTheme, css, getCssText, globalCss, keyframes, styled, theme };
