...
var AvatarConatiner = (0, import_react4.styled)(Avatar.Root, {
  borderRadius: "$full",
...
var {
  ...
  themeMap: __spreadProps(__spreadValues({}, import_react6.defaultThemeMap), {
    height: "space",
    width: "space"
  }),
  theme: {
...
var TextInput = (0, import_react7.forwardRef)(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ import_react7.default.createElement(TextInputContainer, null, !!prefix && /* @__PURE__ */ import_react7.default.createElement(Prefix, null, prefix), /* @__PURE__ */ import_react7.default.createElement(Input, __spreadValues({ ref }, props)));
  }
);
...
function MultiStep({ size, currentStep = 1 }) {
  return /* @__PURE__ */ import_react9.default.createElement(MultiStepContainer, null, /* @__PURE__ */ import_react9.default.createElement(Label, null, "Passo ", currentStep, " de ", size), /* @__PURE__ */ import_react9.default.createElement(Steps, { css: { "--steps-size": size } }, Array.from({ length: size }, (_, i) => i + 1).map((step) => {
...
var ToastComponent = ({ title, date }) => {
  ...
  return /* @__PURE__ */ React5.createElement(ToastContainer, { swipeDirection: "right" }, /* @__PURE__ */ React5.createElement(
    ...
    "Toast Component"
  ), /* @__PURE__ */ React5.createElement(ToastContent, { open, onOpenChange: setOpen }, /* @__PURE__ */ React5.createElement(ToastHeader, null, /* @__PURE__ */ React5.createElement(ToastTitle, null, title), /* @__PURE__ */ React5.createElement(Toast2.Action, { asChild: true, altText: "Goto schedule to undo" }, /* @__PURE__ */ React5.createElement(ToastCloseButton, null, /* @__PURE__ */ React5.createElement(import_phosphor_react3.X, { size: 24 })))), /* @__PURE__ */ React5.createElement(ToastDescription, { asChild: true }, /* @__PURE__ */ React5.createElement("time", { dateTime: eventDateRef.current.toISOString() }, prettyDate(eventDateRef.current)))), /* @__PURE__ */ React5.createElement(Toast2.Viewport, { className: "ToastViewport" }));
};
